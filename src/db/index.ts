 ...
 * Supabase JS client with the anon key (src/lib/supabase/client.ts).
...
/* Startup guard — fail fast with a clear message rather than a cryptic connection error. */
...
/* Transaction pooler connection — prepare: false is required for Supabase pgBouncer. */
